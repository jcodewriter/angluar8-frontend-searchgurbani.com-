...
@Component({
  selector: 'app-common-share-page',
  templateUrl: './common-share-page.component.html',
  styleUrls: ['./common-share-page.component.scss']
})
export class CommonSharePageComponent implements OnInit {
  @Input() page_info: any;
  @Input() title: string;
  ...
  resetFontByDarkMode() {
    if (this.displayMode.dark_mode) {
      this.font = this.defaultFont_dark;
    } else {
      this.font = this.defaultFont;
    }
  }
