...
@Component({
  selector: 'app-common-shabad-print-preview',
  templateUrl: './common-shabad-print-preview.component.html',
  styleUrls: ['./common-shabad-print-preview.component.scss']
})
export class CommonShabadPrintPreviewComponent implements OnInit {
  @Input() page_info: any;
  @Input() title: string;
