...
@Component({
  selector: 'app-dg-share-page',
  templateUrl: './dg-share-page.component.html',
  styleUrls: ['./dg-share-page.component.scss']
})
export class DgSharePageComponent implements OnInit {
  ...
  gotoPage(){
      this.searchService.get_shared_dg('page', this.cur_page, this.cur_selected_line).subscribe(res=>{
        this.page_info = res;
