...
@Component({
  selector: 'app-ggs-ang-line',
  templateUrl: './ggs-ang-line.component.html',
  styleUrls: ['./ggs-ang-line.component.scss']
})
export class GgsAngLineComponent implements OnInit {
