...
@Component({
  selector: 'app-ggs-share-verse',
  templateUrl: './ggs-share-verse.component.html',
  styleUrls: ['./ggs-share-verse.component.scss']
})
export class GgsShareVerseComponent implements OnInit {
  ...
  gotoPage(){
      this.searchService.get_shared_ggs('verse', this.page_no, this.lineno).subscribe(res=>{
        this.page_info = res;
