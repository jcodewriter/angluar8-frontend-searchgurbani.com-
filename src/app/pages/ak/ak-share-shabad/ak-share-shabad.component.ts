...
@Component({
  selector: 'app-ak-share-shabad',
  templateUrl: './ak-share-shabad.component.html',
  styleUrls: ['./ak-share-shabad.component.scss']
})
export class AkShareShabadComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.get_shared_ak_shabad(page, this.cur_selected_line).subscribe(res=>{
        this.page_info = res;
