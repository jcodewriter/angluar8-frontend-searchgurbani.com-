...
@Component({
  selector: 'app-ak-shabad-print-preview',
  templateUrl: './ak-shabad-print-preview.component.html',
  styleUrls: ['./ak-shabad-print-preview.component.scss']
})
export class AkShabadPrintPreviewComponent implements OnInit {
