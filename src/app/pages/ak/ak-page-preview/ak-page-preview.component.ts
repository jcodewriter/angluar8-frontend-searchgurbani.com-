...
@Component({
  selector: 'app-ak-page-preview',
  templateUrl: './ak-page-preview.component.html',
  styleUrls: ['./ak-page-preview.component.scss']
})
export class AkPagePreviewComponent implements OnInit {
