...
@Component({
  selector: 'app-sgshabad-hazare',
  templateUrl: './sgshabad-hazare.component.html',
  styleUrls: ['./sgshabad-hazare.component.scss']
})
export class SgshabadHazareComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.shabad_hazare(page).subscribe(res=>{
        this.page_info = res;
