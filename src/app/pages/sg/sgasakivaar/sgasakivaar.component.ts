...
@Component({
  selector: 'app-sgasakivaar',
  templateUrl: './sgasakivaar.component.html',
  styleUrls: ['./sgasakivaar.component.scss']
})
export class SgasakivaarComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.asa_ki_vaar(page).subscribe(res=>{
        this.page_info = res;
