...
@Component({
  selector: 'app-sgsalok-farid-ji',
  templateUrl: './sgsalok-farid-ji.component.html',
  styleUrls: ['./sgsalok-farid-ji.component.scss']
})
export class SgsalokFaridJiComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.salok_farid_ji(page).subscribe(res=>{
        this.page_info = res;
