...
@Component({
  selector: 'app-sgsalok-kabeer-ji',
  templateUrl: './sgsalok-kabeer-ji.component.html',
  styleUrls: ['./sgsalok-kabeer-ji.component.scss']
})
export class SgsalokKabeerJiComponent implements OnInit {
  ...
  public max_page: number = 20;

  constructor(private searchService: SearchService, private titleSerivce: Title, private meta: Meta) { }
  ...
  gotoPage(page: any){
      this.searchService.salok_kabeer_ji(page).subscribe(res=>{
        this.page_info = res;
        this.titleSerivce.setTitle(res.meta_title);
