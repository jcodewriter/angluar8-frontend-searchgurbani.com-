...
@Component({
  selector: 'app-sgdhakanee-oankaar',
  templateUrl: './sgdhakanee-oankaar.component.html',
  styleUrls: ['./sgdhakanee-oankaar.component.scss']
})
export class SgdhakaneeOankaarComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.dhakanee_oankaar(page).subscribe(res=>{
        this.page_info = res;
