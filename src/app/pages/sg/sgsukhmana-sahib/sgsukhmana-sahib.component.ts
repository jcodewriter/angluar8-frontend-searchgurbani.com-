...
@Component({
  selector: 'app-sgsukhmana-sahib',
  templateUrl: './sgsukhmana-sahib.component.html',
  styleUrls: ['./sgsukhmana-sahib.component.scss']
})
export class SgsukhmanaSahibComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.sukhmana_sahib(page).subscribe(res=>{
        this.page_info = res;
