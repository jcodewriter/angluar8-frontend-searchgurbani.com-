...
@Component({
  selector: 'app-sgchaupaisahib',
  templateUrl: './sgchaupaisahib.component.html',
  styleUrls: ['./sgchaupaisahib.component.scss']
})
export class SgchaupaisahibComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.chaupai_sahib(page).subscribe(res=>{
        this.page_info = res;
