...
@Component({
  selector: 'app-sgjapjisahib',
  templateUrl: './sgjapjisahib.component.html',
  styleUrls: ['./sgjapjisahib.component.scss']
})
export class SgjapjisahibComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.japji_sahib(page).subscribe(res=>{
        this.page_info = res;
