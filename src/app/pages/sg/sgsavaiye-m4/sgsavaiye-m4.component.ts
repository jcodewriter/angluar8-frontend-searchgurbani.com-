...
@Component({
  selector: 'app-sgsavaiye-m4',
  templateUrl: './sgsavaiye-m4.component.html',
  styleUrls: ['./sgsavaiye-m4.component.scss']
})
export class SgsavaiyeM4Component implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.savaiye_m4(page).subscribe(res=>{
        this.page_info = res;
