...
@Component({
  selector: 'app-sgakal-ustati',
  templateUrl: './sgakal-ustati.component.html',
  styleUrls: ['./sgakal-ustati.component.scss']
})
export class SgakalUstatiComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.akal_ustati(page).subscribe(res=>{
        this.page_info = res;
