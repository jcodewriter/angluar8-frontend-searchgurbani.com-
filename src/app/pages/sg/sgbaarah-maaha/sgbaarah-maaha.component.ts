...
@Component({
  selector: 'app-sgbaarah-maaha',
  templateUrl: './sgbaarah-maaha.component.html',
  styleUrls: ['./sgbaarah-maaha.component.scss']
})
export class SgbaarahMaahaComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.baarah_maaha(page).subscribe(res=>{
        this.page_info = res;
