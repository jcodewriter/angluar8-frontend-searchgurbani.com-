...
@Component({
  selector: 'app-sgdukh-bhanjani-sahib',
  templateUrl: './sgdukh-bhanjani-sahib.component.html',
  styleUrls: ['./sgdukh-bhanjani-sahib.component.scss']
})
export class SgdukhBhanjaniSahibComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.dukh_bhanjani_sahib(page).subscribe(res=>{
        this.page_info = res;
