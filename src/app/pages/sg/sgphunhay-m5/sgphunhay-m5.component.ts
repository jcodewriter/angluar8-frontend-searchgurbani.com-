...
@Component({
  selector: 'app-sgphunhay-m5',
  templateUrl: './sgphunhay-m5.component.html',
  styleUrls: ['./sgphunhay-m5.component.scss']
})
export class SgphunhayM5Component implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.phunhay_m5(page).subscribe(res=>{
        this.page_info = res;
