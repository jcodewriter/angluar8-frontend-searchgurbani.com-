...
@Component({
  selector: 'app-sgsavaiye-m3',
  templateUrl: './sgsavaiye-m3.component.html',
  styleUrls: ['./sgsavaiye-m3.component.scss']
})
export class SgsavaiyeM3Component implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.savaiye_m3(page).subscribe(res=>{
        this.page_info = res;
