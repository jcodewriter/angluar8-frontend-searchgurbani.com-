...
@Component({
  selector: 'app-sgsavaiye-m5',
  templateUrl: './sgsavaiye-m5.component.html',
  styleUrls: ['./sgsavaiye-m5.component.scss']
})
export class SgsavaiyeM5Component implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.savaiye_m5(page).subscribe(res=>{
        this.page_info = res;
