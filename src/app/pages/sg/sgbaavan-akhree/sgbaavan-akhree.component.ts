...
@Component({
  selector: 'app-sgbaavan-akhree',
  templateUrl: './sgbaavan-akhree.component.html',
  styleUrls: ['./sgbaavan-akhree.component.scss']
})
export class SgbaavanAkhreeComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.baavan_akhree(page).subscribe(res=>{
        this.page_info = res;
