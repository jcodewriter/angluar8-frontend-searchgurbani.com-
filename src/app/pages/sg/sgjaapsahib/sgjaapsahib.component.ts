...
@Component({
  selector: 'app-sgjaapsahib',
  templateUrl: './sgjaapsahib.component.html',
  styleUrls: ['./sgjaapsahib.component.scss']
})
export class SgjaapsahibComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.jaap_sahib(page).subscribe(res=>{
        this.page_info = res;
