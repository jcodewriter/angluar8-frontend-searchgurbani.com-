...
@Component({
  selector: 'app-sgbachitar-natak',
  templateUrl: './sgbachitar-natak.component.html',
  styleUrls: ['./sgbachitar-natak.component.scss']
})
export class SgbachitarNatakComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.bachitar_natak(page).subscribe(res=>{
        this.page_info = res;
