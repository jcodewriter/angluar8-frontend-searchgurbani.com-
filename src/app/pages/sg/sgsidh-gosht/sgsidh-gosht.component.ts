...
@Component({
  selector: 'app-sgsidh-gosht',
  templateUrl: './sgsidh-gosht.component.html',
  styleUrls: ['./sgsidh-gosht.component.scss']
})
export class SgsidhGoshtComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.sidh_gosht(page).subscribe(res=>{
        this.page_info = res;
