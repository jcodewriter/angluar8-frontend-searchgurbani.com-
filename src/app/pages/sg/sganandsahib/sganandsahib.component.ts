...
@Component({
  selector: 'app-sganandsahib',
  templateUrl: './sganandsahib.component.html',
  styleUrls: ['./sganandsahib.component.scss']
})
export class SganandsahibComponent implements OnInit {
  ...
  gotoPage(page: any){
    // baanis/anand-sahib
      this.searchService.anand_sahib(page).subscribe(res=>{
        this.page_info = res;
