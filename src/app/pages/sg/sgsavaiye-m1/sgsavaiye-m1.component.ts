...
@Component({
  selector: 'app-sgsavaiye-m1',
  templateUrl: './sgsavaiye-m1.component.html',
  styleUrls: ['./sgsavaiye-m1.component.scss']
})
export class SgsavaiyeM1Component implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.savaiye_m1(page).subscribe(res=>{
        this.page_info = res;
