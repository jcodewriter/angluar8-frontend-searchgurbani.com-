...
@Component({
  selector: 'app-sgsukhmani-sahib',
  templateUrl: './sgsukhmani-sahib.component.html',
  styleUrls: ['./sgsukhmani-sahib.component.scss']
})
export class SgsukhmaniSahibComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.sukhmani_sahib(page).subscribe(res=>{
        this.page_info = res;
