...
@Component({
  selector: 'app-sggathaa',
  templateUrl: './sggathaa.component.html',
  styleUrls: ['./sggathaa.component.scss']
})
export class SggathaaComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.gathaa(page).subscribe(res=>{
        this.page_info = res;
