...
@Component({
  selector: 'app-shabad-hazare-paatishahi',
  templateUrl: './shabad-hazare-paatishahi.component.html',
  styleUrls: ['./shabad-hazare-paatishahi.component.scss']
})
export class ShabadHazarePaatishahiComponent implements OnInit {
  ...
  gotoPage(page: any){
    // baanis/tvai-prasadh-savaiye
      this.searchService.shabad_hazare_paatishahi_10(page).subscribe(res=>{
        this.page_info = res;
