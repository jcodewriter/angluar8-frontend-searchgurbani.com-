...
@Component({
  selector: 'app-sgramkali-sadh',
  templateUrl: './sgramkali-sadh.component.html',
  styleUrls: ['./sgramkali-sadh.component.scss']
})
export class SgramkaliSadhComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.ramkali_sadh(page).subscribe(res=>{
        this.page_info = res;
