...
@Component({
  selector: 'app-sgrehraassahib',
  templateUrl: './sgrehraassahib.component.html',
  styleUrls: ['./sgrehraassahib.component.scss']
})
export class SgrehraassahibComponent implements OnInit {
...
// baanis/rehraas-sahib
  gotoPage(page: any){
      this.searchService.rehraas_sahib(page).subscribe(res=>{
        this.page_info = res;
