...
@Component({
  selector: 'app-sgkirtansohila',
  templateUrl: './sgkirtansohila.component.html',
  styleUrls: ['./sgkirtansohila.component.scss']
})
export class SgkirtansohilaComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.kirtan_sohila(page).subscribe(res=>{
        this.page_info = res;
