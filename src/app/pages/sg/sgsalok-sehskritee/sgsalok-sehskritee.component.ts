...
@Component({
  selector: 'app-sgsalok-sehskritee',
  templateUrl: './sgsalok-sehskritee.component.html',
  styleUrls: ['./sgsalok-sehskritee.component.scss']
})
export class SgsalokSehskriteeComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.salok_sehskritee(page).subscribe(res=>{
        this.page_info = res;
