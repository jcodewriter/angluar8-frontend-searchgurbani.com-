...
@Component({
  selector: 'app-bgv-print-preview',
  templateUrl: './bgv-print-preview.component.html',
  styleUrls: ['./bgv-print-preview.component.scss']
})
export class BgvPrintPreviewComponent implements OnInit {
