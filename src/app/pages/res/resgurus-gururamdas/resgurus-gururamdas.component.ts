...
@Component({
  selector: 'app-resgurus-gururamdas',
  templateUrl: './resgurus-gururamdas.component.html',
  styleUrls: ['./resgurus-gururamdas.component.scss']
})
export class ResgurusGururamdasComponent implements OnInit {
