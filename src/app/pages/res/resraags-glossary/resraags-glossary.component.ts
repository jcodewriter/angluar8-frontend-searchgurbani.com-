...
@Component({
  selector: 'app-resraags-glossary',
  templateUrl: './resraags-glossary.component.html',
  styleUrls: ['./resraags-glossary.component.scss']
})
export class ResraagsGlossaryComponent implements OnInit {
