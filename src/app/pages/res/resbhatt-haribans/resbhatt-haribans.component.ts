...
@Component({
  selector: 'app-resbhatt-haribans',
  templateUrl: './resbhatt-haribans.component.html',
  styleUrls: ['./resbhatt-haribans.component.scss']
})
export class ResbhattHaribansComponent implements OnInit {
