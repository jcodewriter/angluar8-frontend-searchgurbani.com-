...
@Component({
  selector: 'app-resgurus-guruharrai',
  templateUrl: './resgurus-guruharrai.component.html',
  styleUrls: ['./resgurus-guruharrai.component.scss']
})
export class ResgurusGuruharraiComponent implements OnInit {
