...
@Component({
  selector: 'app-resgurus-gurugobind5',
  templateUrl: './resgurus-gurugobind5.component.html',
  styleUrls: ['./resgurus-gurugobind5.component.scss']
})
export class ResgurusGurugobind5Component implements OnInit {
