...
@Component({
  selector: 'app-res-sri-guru-granth-darpan-page',
  templateUrl: './res-sri-guru-granth-darpan-page.component.html',
  styleUrls: ['./res-sri-guru-granth-darpan-page.component.scss']
})
export class ResSriGuruGranthDarpanPageComponent implements OnInit {
