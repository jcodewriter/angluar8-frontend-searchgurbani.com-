...
@Component({
  selector: 'app-resraag-jaijaiwanti',
  templateUrl: './resraag-jaijaiwanti.component.html',
  styleUrls: ['./resraag-jaijaiwanti.component.scss']
})
export class ResraagJaijaiwantiComponent implements OnInit {
  ...
  downloadAudio() {
    let path = "raags/" + "raag_jaijaivanti";
