...
@Component({
  selector: 'app-resbhagats-bhagatbeni',
  templateUrl: './resbhagats-bhagatbeni.component.html',
  styleUrls: ['./resbhagats-bhagatbeni.component.scss']
})
export class ResbhagatsBhagatbeniComponent implements OnInit {
