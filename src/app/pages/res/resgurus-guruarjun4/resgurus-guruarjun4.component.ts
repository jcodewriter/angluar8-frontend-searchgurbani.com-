...
@Component({
  selector: 'app-resgurus-guruarjun4',
  templateUrl: './resgurus-guruarjun4.component.html',
  styleUrls: ['./resgurus-guruarjun4.component.scss']
})
export class ResgurusGuruarjun4Component implements OnInit {
