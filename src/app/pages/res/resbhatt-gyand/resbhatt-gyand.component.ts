...
@Component({
  selector: 'app-resbhatt-gyand',
  templateUrl: './resbhatt-gyand.component.html',
  styleUrls: ['./resbhatt-gyand.component.scss']
})
export class ResbhattGyandComponent implements OnInit {
