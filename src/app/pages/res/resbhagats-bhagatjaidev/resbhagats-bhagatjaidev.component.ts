...
@Component({
  selector: 'app-resbhagats-bhagatjaidev',
  templateUrl: './resbhagats-bhagatjaidev.component.html',
  styleUrls: ['./resbhagats-bhagatjaidev.component.scss']
})
export class ResbhagatsBhagatjaidevComponent implements OnInit {
