...
@Component({
  selector: 'app-resraag-thaat-poorvi',
  templateUrl: './resraag-thaat-poorvi.component.html',
  styleUrls: ['./resraag-thaat-poorvi.component.scss']
})
export class ResraagThaatPoorviComponent implements OnInit {
