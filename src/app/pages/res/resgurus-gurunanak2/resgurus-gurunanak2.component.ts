...
@Component({
  selector: 'app-resgurus-gurunanak2',
  templateUrl: './resgurus-gurunanak2.component.html',
  styleUrls: ['./resgurus-gurunanak2.component.scss']
})
export class ResgurusGurunanak2Component implements OnInit {
