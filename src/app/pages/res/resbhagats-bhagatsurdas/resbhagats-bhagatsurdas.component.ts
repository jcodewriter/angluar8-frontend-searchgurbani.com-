...
@Component({
  selector: 'app-resbhagats-bhagatsurdas',
  templateUrl: './resbhagats-bhagatsurdas.component.html',
  styleUrls: ['./resbhagats-bhagatsurdas.component.scss']
})
export class ResbhagatsBhagatsurdasComponent implements OnInit {
