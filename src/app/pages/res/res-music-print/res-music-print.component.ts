...
@Component({
  selector: 'app-res-music-print',
  templateUrl: './res-music-print.component.html',
  styleUrls: ['./res-music-print.component.scss']
})
export class ResMusicPrintComponent implements OnInit {
