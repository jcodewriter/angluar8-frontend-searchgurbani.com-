...
@Component({
  selector: 'app-resraag-thaat-khamaj',
  templateUrl: './resraag-thaat-khamaj.component.html',
  styleUrls: ['./resraag-thaat-khamaj.component.scss']
})
export class ResraagThaatKhamajComponent implements OnInit {
