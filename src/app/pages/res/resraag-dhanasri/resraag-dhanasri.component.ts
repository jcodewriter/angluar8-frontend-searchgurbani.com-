...
@Component({
  selector: 'app-resraag-dhanasri',
  templateUrl: './resraag-dhanasri.component.html',
  styleUrls: ['./resraag-dhanasri.component.scss']
})
export class ResraagDhanasriComponent implements OnInit {
