...
@Component({
  selector: 'app-resbhagats-bhagatravidas',
  templateUrl: './resbhagats-bhagatravidas.component.html',
  styleUrls: ['./resbhagats-bhagatravidas.component.scss']
})
export class ResbhagatsBhagatravidasComponent implements OnInit {
