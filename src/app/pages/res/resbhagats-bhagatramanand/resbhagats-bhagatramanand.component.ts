...
@Component({
  selector: 'app-resbhagats-bhagatramanand',
  templateUrl: './resbhagats-bhagatramanand.component.html',
  styleUrls: ['./resbhagats-bhagatramanand.component.scss']
})
export class ResbhagatsBhagatramanandComponent implements OnInit {
