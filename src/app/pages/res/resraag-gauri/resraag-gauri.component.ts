...
@Component({
  selector: 'app-resraag-gauri',
  templateUrl: './resraag-gauri.component.html',
  styleUrls: ['./resraag-gauri.component.scss']
})
export class ResraagGauriComponent implements OnInit {
