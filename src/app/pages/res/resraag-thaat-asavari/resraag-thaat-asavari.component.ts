...
@Component({
  selector: 'app-resraag-thaat-asavari',
  templateUrl: './resraag-thaat-asavari.component.html',
  styleUrls: ['./resraag-thaat-asavari.component.scss']
})
export class ResraagThaatAsavariComponent implements OnInit {
