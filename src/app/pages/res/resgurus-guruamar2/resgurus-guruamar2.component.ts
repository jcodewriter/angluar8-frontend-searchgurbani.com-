...
@Component({
  selector: 'app-resgurus-guruamar2',
  templateUrl: './resgurus-guruamar2.component.html',
  styleUrls: ['./resgurus-guruamar2.component.scss']
})
export class ResgurusGuruamar2Component implements OnInit {
