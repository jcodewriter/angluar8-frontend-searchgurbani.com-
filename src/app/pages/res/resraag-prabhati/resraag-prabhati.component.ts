...
@Component({
  selector: 'app-resraag-prabhati',
  templateUrl: './resraag-prabhati.component.html',
  styleUrls: ['./resraag-prabhati.component.scss']
})
export class ResraagPrabhatiComponent implements OnInit {
