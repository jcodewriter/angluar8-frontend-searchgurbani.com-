...
@Component({
  selector: 'app-restaal-vibhag',
  templateUrl: './restaal-vibhag.component.html',
  styleUrls: ['./restaal-vibhag.component.scss']
})
export class RestaalVibhagComponent implements OnInit {
