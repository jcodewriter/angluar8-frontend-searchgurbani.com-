...
@Component({
  selector: 'app-resraag-thaat-todi',
  templateUrl: './resraag-thaat-todi.component.html',
  styleUrls: ['./resraag-thaat-todi.component.scss']
})
export class ResraagThaatTodiComponent implements OnInit {
