...
@Component({
  selector: 'app-resbhagats-bhagatparmanand',
  templateUrl: './resbhagats-bhagatparmanand.component.html',
  styleUrls: ['./resbhagats-bhagatparmanand.component.scss']
})
export class ResbhagatsBhagatparmanandComponent implements OnInit {
