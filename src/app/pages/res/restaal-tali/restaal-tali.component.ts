...
@Component({
  selector: 'app-restaal-tali',
  templateUrl: './restaal-tali.component.html',
  styleUrls: ['./restaal-tali.component.scss']
})
export class RestaalTaliComponent implements OnInit {
