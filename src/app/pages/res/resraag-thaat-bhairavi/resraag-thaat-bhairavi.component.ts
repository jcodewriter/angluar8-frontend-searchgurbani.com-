...
@Component({
  selector: 'app-resraag-thaat-bhairavi',
  templateUrl: './resraag-thaat-bhairavi.component.html',
  styleUrls: ['./resraag-thaat-bhairavi.component.scss']
})
export class ResraagThaatBhairaviComponent implements OnInit {
