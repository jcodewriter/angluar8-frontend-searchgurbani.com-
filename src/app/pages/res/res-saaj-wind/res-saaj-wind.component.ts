...
@Component({
  selector: 'app-res-saaj-wind',
  templateUrl: './res-saaj-wind.component.html',
  styleUrls: ['./res-saaj-wind.component.scss']
})
export class ResSaajWindComponent implements OnInit {
