...
@Component({
  selector: 'app-resgurus-gurunanak7',
  templateUrl: './resgurus-gurunanak7.component.html',
  styleUrls: ['./resgurus-gurunanak7.component.scss']
})
export class ResgurusGurunanak7Component implements OnInit {
