...
@Component({
  selector: 'app-resgurus-gurunanak9',
  templateUrl: './resgurus-gurunanak9.component.html',
  styleUrls: ['./resgurus-gurunanak9.component.scss']
})
export class ResgurusGurunanak9Component implements OnInit {
