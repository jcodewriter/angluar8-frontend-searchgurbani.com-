...
@Component({
  selector: 'app-resraag-asa',
  templateUrl: './resraag-asa.component.html',
  styleUrls: ['./resraag-asa.component.scss']
})
export class ResraagAsaComponent implements OnInit {
