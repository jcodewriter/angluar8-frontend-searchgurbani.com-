...
@Component({
  selector: 'app-resraag-bilaval',
  templateUrl: './resraag-bilaval.component.html',
  styleUrls: ['./resraag-bilaval.component.scss']
})
export class ResraagBilavalComponent implements OnInit {
