...
@Component({
  selector: 'app-resgurus-guruarjun',
  templateUrl: './resgurus-guruarjun.component.html',
  styleUrls: ['./resgurus-guruarjun.component.scss']
})
export class ResgurusGuruarjunComponent implements OnInit {
