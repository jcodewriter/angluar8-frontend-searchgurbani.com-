...
@Component({
  selector: 'app-resbhagats-bhagatpipa',
  templateUrl: './resbhagats-bhagatpipa.component.html',
  styleUrls: ['./resbhagats-bhagatpipa.component.scss']
})
export class ResbhagatsBhagatpipaComponent implements OnInit {
