...
@Component({
  selector: 'app-resraag-malar',
  templateUrl: './resraag-malar.component.html',
  styleUrls: ['./resraag-malar.component.scss']
})
export class ResraagMalarComponent implements OnInit {
