...
@Component({
  selector: 'app-resgurus-guruteghbhadur',
  templateUrl: './resgurus-guruteghbhadur.component.html',
  styleUrls: ['./resgurus-guruteghbhadur.component.scss']
})
export class ResgurusGuruteghbhadurComponent implements OnInit {
