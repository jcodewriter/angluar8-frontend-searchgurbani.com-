...
@Component({
  selector: 'app-res-saaj-stringed',
  templateUrl: './res-saaj-stringed.component.html',
  styleUrls: ['./res-saaj-stringed.component.scss']
})
export class ResSaajStringedComponent implements OnInit {
