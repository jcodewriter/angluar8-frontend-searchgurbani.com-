...
@Component({
  selector: 'app-resraag-thaat-kalyan',
  templateUrl: './resraag-thaat-kalyan.component.html',
  styleUrls: ['./resraag-thaat-kalyan.component.scss']
})
export class ResraagThaatKalyanComponent implements OnInit {
