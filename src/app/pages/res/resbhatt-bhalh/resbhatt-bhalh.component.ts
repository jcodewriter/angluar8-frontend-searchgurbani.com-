...
@Component({
  selector: 'app-resbhatt-bhalh',
  templateUrl: './resbhatt-bhalh.component.html',
  styleUrls: ['./resbhatt-bhalh.component.scss']
})
export class ResbhattBhalhComponent implements OnInit {
