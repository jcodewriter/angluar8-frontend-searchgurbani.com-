...
@Component({
  selector: 'app-resgurus-gurugobind6',
  templateUrl: './resgurus-gurugobind6.component.html',
  styleUrls: ['./resgurus-gurugobind6.component.scss']
})
export class ResgurusGurugobind6Component implements OnInit {
