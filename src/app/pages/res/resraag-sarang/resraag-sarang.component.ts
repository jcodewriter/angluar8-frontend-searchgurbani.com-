...
@Component({
  selector: 'app-resraag-sarang',
  templateUrl: './resraag-sarang.component.html',
  styleUrls: ['./resraag-sarang.component.scss']
})
export class ResraagSarangComponent implements OnInit {
