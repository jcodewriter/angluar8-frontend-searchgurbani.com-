...
@Component({
  selector: 'app-res-saaj-tabla',
  templateUrl: './res-saaj-tabla.component.html',
  styleUrls: ['./res-saaj-tabla.component.scss']
})
export class ResSaajTablaComponent implements OnInit {
