...
@Component({
  selector: 'app-resbhatt-jalap',
  templateUrl: './resbhatt-jalap.component.html',
  styleUrls: ['./resbhatt-jalap.component.scss']
})
export class ResbhattJalapComponent implements OnInit {
