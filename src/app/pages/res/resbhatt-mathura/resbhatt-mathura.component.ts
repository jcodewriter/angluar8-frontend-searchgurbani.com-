...
@Component({
  selector: 'app-resbhatt-mathura',
  templateUrl: './resbhatt-mathura.component.html',
  styleUrls: ['./resbhatt-mathura.component.scss']
})
export class ResbhattMathuraComponent implements OnInit {
