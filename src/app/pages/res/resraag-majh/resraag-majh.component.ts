...
@Component({
  selector: 'app-resraag-majh',
  templateUrl: './resraag-majh.component.html',
  styleUrls: ['./resraag-majh.component.scss']
})
export class ResraagMajhComponent implements OnInit {
