...
@Component({
  selector: 'app-resgurus-guruarjun3',
  templateUrl: './resgurus-guruarjun3.component.html',
  styleUrls: ['./resgurus-guruarjun3.component.scss']
})
export class ResgurusGuruarjun3Component implements OnInit {
