...
@Component({
  selector: 'app-resgurus-guruhargobindi2',
  templateUrl: './resgurus-guruhargobindi2.component.html',
  styleUrls: ['./resgurus-guruhargobindi2.component.scss']
})
export class ResgurusGuruhargobindi2Component implements OnInit {
