...
@Component({
  selector: 'app-resgurus-guruangad',
  templateUrl: './resgurus-guruangad.component.html',
  styleUrls: ['./resgurus-guruangad.component.scss']
})
export class ResgurusGuruangadComponent implements OnInit {
