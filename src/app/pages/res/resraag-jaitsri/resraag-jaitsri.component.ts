...
@Component({
  selector: 'app-resraag-jaitsri',
  templateUrl: './resraag-jaitsri.component.html',
  styleUrls: ['./resraag-jaitsri.component.scss']
})
export class ResraagJaitsriComponent implements OnInit {
