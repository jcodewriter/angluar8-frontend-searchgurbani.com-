...
@Component({
  selector: 'app-resgurus-gurugobind4',
  templateUrl: './resgurus-gurugobind4.component.html',
  styleUrls: ['./resgurus-gurugobind4.component.scss']
})
export class ResgurusGurugobind4Component implements OnInit {
