...
@Component({
  selector: 'app-resbhagats-bhagatkabir',
  templateUrl: './resbhagats-bhagatkabir.component.html',
  styleUrls: ['./resbhagats-bhagatkabir.component.scss']
})
export class ResbhagatsBhagatkabirComponent implements OnInit {
