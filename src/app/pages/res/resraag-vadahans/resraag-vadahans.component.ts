...
@Component({
  selector: 'app-resraag-vadahans',
  templateUrl: './resraag-vadahans.component.html',
  styleUrls: ['./resraag-vadahans.component.scss']
})
export class ResraagVadahansComponent implements OnInit {
