...
@Component({
  selector: 'app-resraag-thaat-kafi',
  templateUrl: './resraag-thaat-kafi.component.html',
  styleUrls: ['./resraag-thaat-kafi.component.scss']
})
export class ResraagThaatKafiComponent implements OnInit {
