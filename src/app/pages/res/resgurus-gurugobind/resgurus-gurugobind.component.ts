...
@Component({
  selector: 'app-resgurus-gurugobind',
  templateUrl: './resgurus-gurugobind.component.html',
  styleUrls: ['./resgurus-gurugobind.component.scss']
})
export class ResgurusGurugobindComponent implements OnInit {
