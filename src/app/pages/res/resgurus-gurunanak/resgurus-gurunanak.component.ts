...
@Component({
  selector: 'app-resgurus-gurunanak',
  templateUrl: './resgurus-gurunanak.component.html',
  styleUrls: ['./resgurus-gurunanak.component.scss']
})
export class ResgurusGurunanakComponent implements OnInit {
