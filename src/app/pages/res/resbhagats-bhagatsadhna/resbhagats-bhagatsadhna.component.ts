...
@Component({
  selector: 'app-resbhagats-bhagatsadhna',
  templateUrl: './resbhagats-bhagatsadhna.component.html',
  styleUrls: ['./resbhagats-bhagatsadhna.component.scss']
})
export class ResbhagatsBhagatsadhnaComponent implements OnInit {
