...
@Component({
  selector: 'app-resraag-kanara',
  templateUrl: './resraag-kanara.component.html',
  styleUrls: ['./resraag-kanara.component.scss']
})
export class ResraagKanaraComponent implements OnInit {
