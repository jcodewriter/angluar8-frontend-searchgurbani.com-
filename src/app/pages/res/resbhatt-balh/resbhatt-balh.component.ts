...
@Component({
  selector: 'app-resbhatt-balh',
  templateUrl: './resbhatt-balh.component.html',
  styleUrls: ['./resbhatt-balh.component.scss']
})
export class ResbhattBalhComponent implements OnInit {
