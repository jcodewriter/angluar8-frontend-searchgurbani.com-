...
@Component({
  selector: 'app-resgurus-gurugobind7',
  templateUrl: './resgurus-gurugobind7.component.html',
  styleUrls: ['./resgurus-gurugobind7.component.scss']
})
export class ResgurusGurugobind7Component implements OnInit {
