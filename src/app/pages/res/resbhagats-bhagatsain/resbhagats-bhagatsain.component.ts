...
@Component({
  selector: 'app-resbhagats-bhagatsain',
  templateUrl: './resbhagats-bhagatsain.component.html',
  styleUrls: ['./resbhagats-bhagatsain.component.scss']
})
export class ResbhagatsBhagatsainComponent implements OnInit {
