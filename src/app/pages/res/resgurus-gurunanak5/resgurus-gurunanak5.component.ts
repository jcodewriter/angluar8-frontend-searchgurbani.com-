...
@Component({
  selector: 'app-resgurus-gurunanak5',
  templateUrl: './resgurus-gurunanak5.component.html',
  styleUrls: ['./resgurus-gurunanak5.component.scss']
})
export class ResgurusGurunanak5Component implements OnInit {
