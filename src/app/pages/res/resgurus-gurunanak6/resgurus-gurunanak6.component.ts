...
@Component({
  selector: 'app-resgurus-gurunanak6',
  templateUrl: './resgurus-gurunanak6.component.html',
  styleUrls: ['./resgurus-gurunanak6.component.scss']
})
export class ResgurusGurunanak6Component implements OnInit {
