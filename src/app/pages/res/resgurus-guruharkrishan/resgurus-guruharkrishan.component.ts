...
@Component({
  selector: 'app-resgurus-guruharkrishan',
  templateUrl: './resgurus-guruharkrishan.component.html',
  styleUrls: ['./resgurus-guruharkrishan.component.scss']
})
export class ResgurusGuruharkrishanComponent implements OnInit {
