...
@Component({
  selector: 'app-resgurus-gurunanak10',
  templateUrl: './resgurus-gurunanak10.component.html',
  styleUrls: ['./resgurus-gurunanak10.component.scss']
})
export class ResgurusGurunanak10Component implements OnInit {
