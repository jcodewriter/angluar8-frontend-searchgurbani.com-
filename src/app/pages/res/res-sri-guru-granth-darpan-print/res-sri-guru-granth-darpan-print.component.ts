...
@Component({
  selector: 'app-res-sri-guru-granth-darpan-print',
  templateUrl: './res-sri-guru-granth-darpan-print.component.html',
  styleUrls: ['./res-sri-guru-granth-darpan-print.component.scss']
})
export class ResSriGuruGranthDarpanPrintComponent implements OnInit {
  footerColor = "#4f022c";
  public pageInfo: any;
  ...
  get_page_info(page: number) {
    this.searchService.sggd_page(page, this.volume_id).subscribe(res=>{
      this.pageInfo = res;
