...
@Component({
  selector: 'app-resbhatts-satta',
  templateUrl: './resbhatts-satta.component.html',
  styleUrls: ['./resbhatts-satta.component.scss']
})
export class ResbhattsSattaComponent implements OnInit {
