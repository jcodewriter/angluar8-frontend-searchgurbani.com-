...
@Component({
  selector: 'app-resraag-bairari',
  templateUrl: './resraag-bairari.component.html',
  styleUrls: ['./resraag-bairari.component.scss']
})
export class ResraagBairariComponent implements OnInit {
