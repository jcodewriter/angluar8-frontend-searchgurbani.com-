...
@Component({
  selector: 'app-resbhagats-bhagattrilochan',
  templateUrl: './resbhagats-bhagattrilochan.component.html',
  styleUrls: ['./resbhagats-bhagattrilochan.component.scss']
})
export class ResbhagatsBhagattrilochanComponent implements OnInit {
