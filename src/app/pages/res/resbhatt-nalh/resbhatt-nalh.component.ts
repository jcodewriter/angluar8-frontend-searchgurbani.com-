...
@Component({
  selector: 'app-resbhatt-nalh',
  templateUrl: './resbhatt-nalh.component.html',
  styleUrls: ['./resbhatt-nalh.component.scss']
})
export class ResbhattNalhComponent implements OnInit {
