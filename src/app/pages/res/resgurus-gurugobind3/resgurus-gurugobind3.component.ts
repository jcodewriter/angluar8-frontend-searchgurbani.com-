...
@Component({
  selector: 'app-resgurus-gurugobind3',
  templateUrl: './resgurus-gurugobind3.component.html',
  styleUrls: ['./resgurus-gurugobind3.component.scss']
})
export class ResgurusGurugobind3Component implements OnInit {
