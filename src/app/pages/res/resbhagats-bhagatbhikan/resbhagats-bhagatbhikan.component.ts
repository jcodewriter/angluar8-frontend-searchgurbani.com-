...
@Component({
  selector: 'app-resbhagats-bhagatbhikan',
  templateUrl: './resbhagats-bhagatbhikan.component.html',
  styleUrls: ['./resbhagats-bhagatbhikan.component.scss']
})
export class ResbhagatsBhagatbhikanComponent implements OnInit {
