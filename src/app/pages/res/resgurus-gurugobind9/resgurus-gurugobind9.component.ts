...
@Component({
  selector: 'app-resgurus-gurugobind9',
  templateUrl: './resgurus-gurugobind9.component.html',
  styleUrls: ['./resgurus-gurugobind9.component.scss']
})
export class ResgurusGurugobind9Component implements OnInit {
