...
@Component({
  selector: 'app-restaal-avartan',
  templateUrl: './restaal-avartan.component.html',
  styleUrls: ['./restaal-avartan.component.scss']
})
export class RestaalAvartanComponent implements OnInit {
