...
@Component({
  selector: 'app-resraag-maligaura',
  templateUrl: './resraag-maligaura.component.html',
  styleUrls: ['./resraag-maligaura.component.scss']
})
export class ResraagMaligauraComponent implements OnInit {
