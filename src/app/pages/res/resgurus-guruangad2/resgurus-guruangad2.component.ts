...
@Component({
  selector: 'app-resgurus-guruangad2',
  templateUrl: './resgurus-guruangad2.component.html',
  styleUrls: ['./resgurus-guruangad2.component.scss']
})
export class ResgurusGuruangad2Component implements OnInit {
