...
@Component({
  selector: 'app-resgurus-guruarjun2',
  templateUrl: './resgurus-guruarjun2.component.html',
  styleUrls: ['./resgurus-guruarjun2.component.scss']
})
export class ResgurusGuruarjun2Component implements OnInit {
