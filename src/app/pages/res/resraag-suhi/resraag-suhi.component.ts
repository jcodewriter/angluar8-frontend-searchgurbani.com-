...
@Component({
  selector: 'app-resraag-suhi',
  templateUrl: './resraag-suhi.component.html',
  styleUrls: ['./resraag-suhi.component.scss']
})
export class ResraagSuhiComponent implements OnInit {
