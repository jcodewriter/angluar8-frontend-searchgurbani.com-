...
@Component({
  selector: 'app-resgurus-gurunanak4',
  templateUrl: './resgurus-gurunanak4.component.html',
  styleUrls: ['./resgurus-gurunanak4.component.scss']
})
export class ResgurusGurunanak4Component implements OnInit {
