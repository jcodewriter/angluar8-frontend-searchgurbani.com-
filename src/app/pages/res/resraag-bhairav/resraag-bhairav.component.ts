...
@Component({
  selector: 'app-resraag-bhairav',
  templateUrl: './resraag-bhairav.component.html',
  styleUrls: ['./resraag-bhairav.component.scss']
})
export class ResraagBhairavComponent implements OnInit {
