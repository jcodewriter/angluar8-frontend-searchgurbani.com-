...
@Component({
  selector: 'app-restaal-taal-rupak',
  templateUrl: './restaal-taal-rupak.component.html',
  styleUrls: ['./restaal-taal-rupak.component.scss']
})
export class RestaalTaalRupakComponent implements OnInit {
