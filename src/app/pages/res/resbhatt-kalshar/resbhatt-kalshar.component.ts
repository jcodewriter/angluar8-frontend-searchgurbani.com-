...
@Component({
  selector: 'app-resbhatt-kalshar',
  templateUrl: './resbhatt-kalshar.component.html',
  styleUrls: ['./resbhatt-kalshar.component.scss']
})
export class ResbhattKalsharComponent implements OnInit {
