...
@Component({
  selector: 'app-resraag-gond',
  templateUrl: './resraag-gond.component.html',
  styleUrls: ['./resraag-gond.component.scss']
})
export class ResraagGondComponent implements OnInit {
