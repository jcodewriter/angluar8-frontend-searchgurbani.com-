...
@Component({
  selector: 'app-resraag-thaat-marwa',
  templateUrl: './resraag-thaat-marwa.component.html',
  styleUrls: ['./resraag-thaat-marwa.component.scss']
})
export class ResraagThaatMarwaComponent implements OnInit {
