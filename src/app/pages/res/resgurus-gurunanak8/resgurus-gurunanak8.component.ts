...
@Component({
  selector: 'app-resgurus-gurunanak8',
  templateUrl: './resgurus-gurunanak8.component.html',
  styleUrls: ['./resgurus-gurunanak8.component.scss']
})
export class ResgurusGurunanak8Component implements OnInit {
