...
@Component({
  selector: 'app-resraag-maru',
  templateUrl: './resraag-maru.component.html',
  styleUrls: ['./resraag-maru.component.scss']
})
export class ResraagMaruComponent implements OnInit {
