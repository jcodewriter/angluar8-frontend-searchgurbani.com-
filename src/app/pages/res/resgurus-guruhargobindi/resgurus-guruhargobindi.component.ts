...
@Component({
  selector: 'app-resgurus-guruhargobindi',
  templateUrl: './resgurus-guruhargobindi.component.html',
  styleUrls: ['./resgurus-guruhargobindi.component.scss']
})
export class ResgurusGuruhargobindiComponent implements OnInit {
