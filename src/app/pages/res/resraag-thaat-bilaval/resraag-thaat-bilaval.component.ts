...
@Component({
  selector: 'app-resraag-thaat-bilaval',
  templateUrl: './resraag-thaat-bilaval.component.html',
  styleUrls: ['./resraag-thaat-bilaval.component.scss']
})
export class ResraagThaatBilavalComponent implements OnInit {
