...
@Component({
  selector: 'app-resbhatt-kirat',
  templateUrl: './resbhatt-kirat.component.html',
  styleUrls: ['./resbhatt-kirat.component.scss']
})
export class ResbhattKiratComponent implements OnInit {
