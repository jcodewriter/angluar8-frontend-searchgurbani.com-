...
@Component({
  selector: 'app-resgurus-guruhargobindi4',
  templateUrl: './resgurus-guruhargobindi4.component.html',
  styleUrls: ['./resgurus-guruhargobindi4.component.scss']
})
export class ResgurusGuruhargobindi4Component implements OnInit {
