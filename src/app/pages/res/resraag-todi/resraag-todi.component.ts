...
@Component({
  selector: 'app-resraag-todi',
  templateUrl: './resraag-todi.component.html',
  styleUrls: ['./resraag-todi.component.scss']
})
export class ResraagTodiComponent implements OnInit {
