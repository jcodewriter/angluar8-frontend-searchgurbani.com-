...
@Component({
  selector: 'app-resraag-gujri',
  templateUrl: './resraag-gujri.component.html',
  styleUrls: ['./resraag-gujri.component.scss']
})
export class ResraagGujriComponent implements OnInit {
