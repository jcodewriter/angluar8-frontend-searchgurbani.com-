...
@Component({
  selector: 'app-restaal-index',
  templateUrl: './restaal-index.component.html',
  styleUrls: ['./restaal-index.component.scss']
})
export class RestaalIndexComponent implements OnInit {
