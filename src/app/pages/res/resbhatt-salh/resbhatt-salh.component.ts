...
@Component({
  selector: 'app-resbhatt-salh',
  templateUrl: './resbhatt-salh.component.html',
  styleUrls: ['./resbhatt-salh.component.scss']
})
export class ResbhattSalhComponent implements OnInit {
