...
@Component({
  selector: 'app-resbhagats-bhagatnamdev',
  templateUrl: './resbhagats-bhagatnamdev.component.html',
  styleUrls: ['./resbhagats-bhagatnamdev.component.scss']
})
export class ResbhagatsBhagatnamdevComponent implements OnInit {
