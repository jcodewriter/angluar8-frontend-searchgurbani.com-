...
@Component({
  selector: 'app-resraag-bihagara',
  templateUrl: './resraag-bihagara.component.html',
  styleUrls: ['./resraag-bihagara.component.scss']
})
export class ResraagBihagaraComponent implements OnInit {
