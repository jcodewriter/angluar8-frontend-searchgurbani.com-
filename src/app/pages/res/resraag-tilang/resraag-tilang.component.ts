...
@Component({
  selector: 'app-resraag-tilang',
  templateUrl: './resraag-tilang.component.html',
  styleUrls: ['./resraag-tilang.component.scss']
})
export class ResraagTilangComponent implements OnInit {
