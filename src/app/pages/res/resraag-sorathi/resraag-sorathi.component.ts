...
@Component({
  selector: 'app-resraag-sorathi',
  templateUrl: './resraag-sorathi.component.html',
  styleUrls: ['./resraag-sorathi.component.scss']
})
export class ResraagSorathiComponent implements OnInit {
