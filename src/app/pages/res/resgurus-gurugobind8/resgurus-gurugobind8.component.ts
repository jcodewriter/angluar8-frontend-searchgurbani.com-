...
@Component({
  selector: 'app-resgurus-gurugobind8',
  templateUrl: './resgurus-gurugobind8.component.html',
  styleUrls: ['./resgurus-gurugobind8.component.scss']
})
export class ResgurusGurugobind8Component implements OnInit {
