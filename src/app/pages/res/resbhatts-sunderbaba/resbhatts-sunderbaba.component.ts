...
@Component({
  selector: 'app-resbhatts-sunderbaba',
  templateUrl: './resbhatts-sunderbaba.component.html',
  styleUrls: ['./resbhatts-sunderbaba.component.scss']
})
export class ResbhattsSunderbabaComponent implements OnInit {
