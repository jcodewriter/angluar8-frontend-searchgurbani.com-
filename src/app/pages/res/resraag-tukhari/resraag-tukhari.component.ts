...
@Component({
  selector: 'app-resraag-tukhari',
  templateUrl: './resraag-tukhari.component.html',
  styleUrls: ['./resraag-tukhari.component.scss']
})
export class ResraagTukhariComponent implements OnInit {
