...
@Component({
  selector: 'app-restaal-taal-teen',
  templateUrl: './restaal-taal-teen.component.html',
  styleUrls: ['./restaal-taal-teen.component.scss']
})
export class RestaalTaalTeenComponent implements OnInit {
