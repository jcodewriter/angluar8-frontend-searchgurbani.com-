...
@Component({
  selector: 'app-resbhagats-bhagatdhanna',
  templateUrl: './resbhagats-bhagatdhanna.component.html',
  styleUrls: ['./resbhagats-bhagatdhanna.component.scss']
})
export class ResbhagatsBhagatdhannaComponent implements OnInit {
