...
@Component({
  selector: 'app-resgurus-guruangad3',
  templateUrl: './resgurus-guruangad3.component.html',
  styleUrls: ['./resgurus-guruangad3.component.scss']
})
export class ResgurusGuruangad3Component implements OnInit {
