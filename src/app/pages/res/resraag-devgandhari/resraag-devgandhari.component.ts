...
@Component({
  selector: 'app-resraag-devgandhari',
  templateUrl: './resraag-devgandhari.component.html',
  styleUrls: ['./resraag-devgandhari.component.scss']
})
export class ResraagDevgandhariComponent implements OnInit {
  ...
  downloadAudio() {
    let path = "raags/" + "raag_devgandhari";
