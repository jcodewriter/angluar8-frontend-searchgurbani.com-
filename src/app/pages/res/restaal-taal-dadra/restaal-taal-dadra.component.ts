...
@Component({
  selector: 'app-restaal-taal-dadra',
  templateUrl: './restaal-taal-dadra.component.html',
  styleUrls: ['./restaal-taal-dadra.component.scss']
})
export class RestaalTaalDadraComponent implements OnInit {
