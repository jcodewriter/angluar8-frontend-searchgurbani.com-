...
@Component({
  selector: 'app-resraag-nutnarain',
  templateUrl: './resraag-nutnarain.component.html',
  styleUrls: ['./resraag-nutnarain.component.scss']
})
export class ResraagNutnarainComponent implements OnInit {
