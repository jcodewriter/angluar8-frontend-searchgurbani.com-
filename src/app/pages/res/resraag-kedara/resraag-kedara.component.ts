...
@Component({
  selector: 'app-resraag-kedara',
  templateUrl: './resraag-kedara.component.html',
  styleUrls: ['./resraag-kedara.component.scss']
})
export class ResraagKedaraComponent implements OnInit {
