...
@Component({
  selector: 'app-restaal-matra',
  templateUrl: './restaal-matra.component.html',
  styleUrls: ['./restaal-matra.component.scss']
})
export class RestaalMatraComponent implements OnInit {
