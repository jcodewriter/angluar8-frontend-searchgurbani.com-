...
@Component({
  selector: 'app-restaal-khali',
  templateUrl: './restaal-khali.component.html',
  styleUrls: ['./restaal-khali.component.scss']
})
export class RestaalKhaliComponent implements OnInit {
