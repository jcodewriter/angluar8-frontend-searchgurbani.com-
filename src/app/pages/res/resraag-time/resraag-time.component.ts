...
@Component({
  selector: 'app-resraag-time',
  templateUrl: './resraag-time.component.html',
  styleUrls: ['./resraag-time.component.scss']
})
export class ResraagTimeComponent implements OnInit {
