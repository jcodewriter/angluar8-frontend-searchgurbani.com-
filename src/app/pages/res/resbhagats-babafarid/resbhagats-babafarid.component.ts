...
@Component({
  selector: 'app-resbhagats-babafarid',
  templateUrl: './resbhagats-babafarid.component.html',
  styleUrls: ['./resbhagats-babafarid.component.scss']
})
export class ResbhagatsBabafaridComponent implements OnInit {
