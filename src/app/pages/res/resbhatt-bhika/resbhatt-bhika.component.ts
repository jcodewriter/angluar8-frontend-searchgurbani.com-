...
@Component({
  selector: 'app-resbhatt-bhika',
  templateUrl: './resbhatt-bhika.component.html',
  styleUrls: ['./resbhatt-bhika.component.scss']
})
export class ResbhattBhikaComponent implements OnInit {
