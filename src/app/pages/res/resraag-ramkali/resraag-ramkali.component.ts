...
@Component({
  selector: 'app-resraag-ramkali',
  templateUrl: './resraag-ramkali.component.html',
  styleUrls: ['./resraag-ramkali.component.scss']
})
export class ResraagRamkaliComponent implements OnInit {
