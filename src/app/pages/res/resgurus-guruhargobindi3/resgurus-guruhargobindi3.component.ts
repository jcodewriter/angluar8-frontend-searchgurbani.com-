...
@Component({
  selector: 'app-resgurus-guruhargobindi3',
  templateUrl: './resgurus-guruhargobindi3.component.html',
  styleUrls: ['./resgurus-guruhargobindi3.component.scss']
})
export class ResgurusGuruhargobindi3Component implements OnInit {
