...
@Component({
  selector: 'app-resgurus-gurugobind2',
  templateUrl: './resgurus-gurugobind2.component.html',
  styleUrls: ['./resgurus-gurugobind2.component.scss']
})
export class ResgurusGurugobind2Component implements OnInit {
