...
@Component({
  selector: 'app-resgurus-guruamar',
  templateUrl: './resgurus-guruamar.component.html',
  styleUrls: ['./resgurus-guruamar.component.scss']
})
export class ResgurusGuruamarComponent implements OnInit {
