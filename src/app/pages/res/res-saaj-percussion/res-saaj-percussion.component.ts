...
@Component({
  selector: 'app-res-saaj-percussion',
  templateUrl: './res-saaj-percussion.component.html',
  styleUrls: ['./res-saaj-percussion.component.scss']
})
export class ResSaajPercussionComponent implements OnInit {
