...
@Component({
  selector: 'app-resraag-thaat-bhairav',
  templateUrl: './resraag-thaat-bhairav.component.html',
  styleUrls: ['./resraag-thaat-bhairav.component.scss']
})
export class ResraagThaatBhairavComponent implements OnInit {
