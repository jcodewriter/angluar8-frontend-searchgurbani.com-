...
@Component({
  selector: 'app-bnlghazal',
  templateUrl: './bnlghazal.component.html',
  styleUrls: ['./bnlghazal.component.scss']
})
export class BnlghazalComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.bnl_ghazal_page(page).subscribe(res=>{
        this.page_info = res;
