...
@Component({
  selector: 'app-bnljotbikas',
  templateUrl: './bnljotbikas.component.html',
  styleUrls: ['./bnljotbikas.component.scss']
})
export class BnljotbikasComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.bnl_jb_page(page).subscribe(res=>{
        this.page_info = res;
