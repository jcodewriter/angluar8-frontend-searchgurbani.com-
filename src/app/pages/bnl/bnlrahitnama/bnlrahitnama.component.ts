...
@Component({
  selector: 'app-bnlrahitnama',
  templateUrl: './bnlrahitnama.component.html',
  styleUrls: ['./bnlrahitnama.component.scss']
})
export class BnlrahitnamaComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.bnl_rahitnama_page(page).subscribe(res=>{
        this.page_info = res;
