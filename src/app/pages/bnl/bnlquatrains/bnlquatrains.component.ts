...
@Component({
  selector: 'app-bnlquatrains',
  templateUrl: './bnlquatrains.component.html',
  styleUrls: ['./bnlquatrains.component.scss']
})
export class BnlquatrainsComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.bnl_quatrains_page(page).subscribe(res=>{
