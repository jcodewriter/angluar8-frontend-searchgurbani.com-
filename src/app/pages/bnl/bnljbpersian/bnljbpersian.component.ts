...
@Component({
  selector: 'app-bnljbpersian',
  templateUrl: './bnljbpersian.component.html',
  styleUrls: ['./bnljbpersian.component.scss']
})
export class BnljbpersianComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.bnl_jb_person_page(page).subscribe(res=>{
        this.page_info = res;
