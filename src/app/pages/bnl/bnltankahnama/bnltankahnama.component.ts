...
@Component({
  selector: 'app-bnltankahnama',
  templateUrl: './bnltankahnama.component.html',
  styleUrls: ['./bnltankahnama.component.scss']
})
export class BnltankahnamaComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.bnl_tankahnama_page(page).subscribe(res=>{
        this.page_info = res;
