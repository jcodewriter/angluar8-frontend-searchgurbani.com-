...
@Component({
  selector: 'app-bnl-verse-print',
  templateUrl: './bnl-verse-print.component.html',
  styleUrls: ['./bnl-verse-print.component.scss']
})
export class BnlVersePrintComponent implements OnInit {
