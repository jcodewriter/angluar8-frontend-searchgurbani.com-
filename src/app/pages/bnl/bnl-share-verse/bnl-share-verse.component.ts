...
@Component({
  selector: 'app-bnl-share-verse',
  templateUrl: './bnl-share-verse.component.html',
  styleUrls: ['./bnl-share-verse.component.scss']
})
export class BnlShareVerseComponent implements OnInit {
  ...
  gotoPage(page: any){
      this.searchService.get_shared_bnl_page(this.type, 'verse', page, this.lineno).subscribe(res=>{
        this.page_info = res;
