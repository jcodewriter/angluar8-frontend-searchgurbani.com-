...
@Component({
  selector: 'app-bnl-print-preview',
  templateUrl: './bnl-print-preview.component.html',
  styleUrls: ['./bnl-print-preview.component.scss']
})
export class BnlPrintPreviewComponent implements OnInit {
  ...
  gotoPage(){
    this.searchService.bnl_page(this.type, this.page_no).subscribe(res=>{
      this.page_info = res;
