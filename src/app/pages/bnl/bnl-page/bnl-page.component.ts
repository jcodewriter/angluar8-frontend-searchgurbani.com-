...
@Component({
  selector: 'app-bnl-page',
  templateUrl: './bnl-page.component.html',
  styleUrls: ['./bnl-page.component.scss']
})
export class BnlPageComponent implements OnInit {
  ...
  gotoPage(page){
    this.searchService.bnl_page(this.type, page).subscribe(res=>{
      this.page_info = res;
