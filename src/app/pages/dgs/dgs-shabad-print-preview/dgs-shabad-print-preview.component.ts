...
@Component({
  selector: 'app-dgs-shabad-print-preview',
  templateUrl: './dgs-shabad-print-preview.component.html',
  styleUrls: ['./dgs-shabad-print-preview.component.scss']
})
export class DgsShabadPrintPreviewComponent implements OnInit {
