...
@Component({
  selector: 'app-dgs-verse-print',
  templateUrl: './dgs-verse-print.component.html',
  styleUrls: ['./dgs-verse-print.component.scss']
})
export class DgsVersePrintComponent implements OnInit {
