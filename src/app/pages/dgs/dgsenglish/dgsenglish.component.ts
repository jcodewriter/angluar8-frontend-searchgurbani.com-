...
@Component({
  selector: 'app-dgsenglish',
  templateUrl: './dgsenglish.component.html',
  styleUrls: ['./dgsenglish.component.scss']
})
export class DGSEnglishComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.searchService.dgs_chapter_index('en').subscribe(res=>{
      if(res){
