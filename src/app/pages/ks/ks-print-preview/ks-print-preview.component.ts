...
@Component({
  selector: 'app-ks-print-preview',
  templateUrl: './ks-print-preview.component.html',
  styleUrls: ['./ks-print-preview.component.scss']
})
export class KsPrintPreviewComponent implements OnInit {
